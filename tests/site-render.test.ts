...
describe('renderSite variants', () => {
  ...
  it('音樂版 Logo 會輸出森林、飛鳥與麥克風的開場動畫', () => {
    ...
    expect(musicHtml).toContain('.music-logo-final{display:block;width:100%;height:100%;margin:0;object-fit:contain;transform:scale(1.05);transform-origin:center;');
