...
export function renderSite(t: Tenant): string {
  ...
  const musicLogoCss = musicMotionEnabled
    ? `.music-logo-animation{position:relative;display:block;width:min(190px,45vw);aspect-ratio:1;margin:0 auto 24px}.music-logo-composite{position:absolute;inset:0}.music-logo-layer-stack{position:absolute;inset:0;animation:music-logo-layers-exit 620ms ease-out 4.15s both}.music-logo-layer{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;opacity:0;transform-origin:center;pointer-events:none}.music-logo-layer-ring{z-index:1;animation:music-logo-ring 1.1s ease-out .05s both}.music-logo-layer-forest-left{z-index:4;animation:music-logo-forest-left 1.3s cubic-bezier(.2,.8,.2,1) both}.music-logo-layer-forest-right{z-index:6;animation:music-logo-forest-right 1.3s cubic-bezier(.2,.8,.2,1) both}.music-logo-layer-bird{z-index:5;animation:music-logo-bird-flight 2.9s cubic-bezier(.2,.75,.25,1) .7s both}.music-logo-layer-microphone{z-index:3;animation:music-logo-microphone-arrive 2s cubic-bezier(.2,.85,.25,1) 1.8s both}.music-logo-layer-notes{z-index:2;animation:music-logo-notes 1s ease-out 3.2s both}.music-logo-final-frame{position:absolute;inset:0;z-index:7;opacity:0;pointer-events:none;animation:music-logo-final 620ms ease-out 4.15s both}.music-logo-final{display:block;width:100%;height:100%;margin:0;object-fit:contain;border:0;border-radius:0;box-shadow:none}@keyframes music-logo-ring{0%{opacity:0;transform:scale(.78) rotate(-5deg)}100%{opacity:1;transform:scale(1.05) rotate(0)}}@keyframes music-logo-forest-left{0%{opacity:0;transform:translate(-120px,18px) scale(.48) rotate(-12deg)}22%{opacity:1}100%{opacity:1;transform:translate(-95px,0) scale(.64) rotate(-3deg)}}@keyframes music-logo-forest-right{0%{opacity:0;transform:translate(120px,18px) scale(.48) rotate(12deg)}22%{opacity:1}100%{opacity:1;transform:translate(95px,0) scale(.64) rotate(3deg)}}@keyframes music-logo-bird-flight{0%{opacity:0;transform:translate(-140px,44px) rotate(-10deg) scale(.62)}22%{opacity:1}52%{transform:translate(-32px,-10px) rotate(6deg) scale(.92)}78%{transform:translate(14px,2px) rotate(-2deg) scale(1.05)}100%{opacity:1;transform:translate(0,0) rotate(0) scale(1.05)}}@keyframes music-logo-microphone-arrive{0%,42%{opacity:0;transform:translate(0,18px) scale(.15)}72%{opacity:1;transform:translate(0,3px) scale(.95)}100%{opacity:1;transform:translate(0,0) scale(.95)}}@keyframes music-logo-notes{0%{opacity:0;transform:translateY(14px) scale(.78)}100%{opacity:.88;transform:translateY(0) scale(.92)}}@keyframes music-logo-layers-exit{0%{opacity:1}100%{opacity:0}}@keyframes music-logo-final{0%{opacity:0}100%{opacity:1}}`
    : '';
